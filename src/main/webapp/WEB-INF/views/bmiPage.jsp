...
</li><li class="u-nav-item"><a class="u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-text-hover-palette-2-base u-text-white" href="bmi/bmiPage.my" style="padding: 10px;">JoinPage</a>
</li></ul>
          </div>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="bmiPage.my" style="padding: 10px;">JoinPage</a>
</li></ul>
              </div>
            </div>
