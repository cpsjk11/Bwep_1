<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<header class="u-clearfix u-custom-color-5 u-header u-header" id="sec-b9b0"><div class="u-clearfix u-sheet u-sheet-1">
<nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
...
</li><li class="u-nav-item"><a class="u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-text-hover-palette-2-base u-text-white" href="javascript:location.href='bmiPage.my'" style="padding: 10px;">bmi</a>
</li></ul>
          </div>
         ...
         <a href="membership.my" style="color: white; cursor: wait;"><p class="u-custom-font u-text u-text-1">Bwep</p></a>
      </div></header>